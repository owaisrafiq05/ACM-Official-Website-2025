...
export function Events() {
  ...
  return (
    <div className="mt-12 lg:pl-20 relative">
      
      {/* SVG background */}
      <img 
        src={BgShape} 
        alt="Decorative background" 
        className="absolute top-10 left-0 w-full h-auto opacity-70 pointer-events-none"
      />
      ...
      <EventCard
        ...
        logo={CodersCupLogo}
        description="The Coders' Cup is an intra-FAST programming competition..."
 ...
 <img 
  ...
  className="absolute w-full h-auto opacity-70 my-16"
/>
      ...
      <EventCard
        ...
        logo={``}
        description="Interactive sessions and workshops designed to spark creativity..."
