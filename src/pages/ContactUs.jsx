...
const ContactUs = () => {
  ...
  const renderCard = (title, content, index = 0) => {
    ...
    // Different heights: location card (index 0) is taller, contact detail cards are shorter
    const cardHeight = index === 0 ? "h-48" : "h-[175px]";
    const textHeight = index === 0 ? "pt-3" : "pt-7";

    return (
      <div className={`relative w-full ${cardHeight} mb-4 overflow-hidden rounded-3xl shadow-lg bg-white`}>
        {/* Card Content */}
        <div className="relative w-full h-full p-3 flex flex-col justify-start">
          {/* Main content area */}
          <div className={`flex-1 pb-1 ${textHeight}`}>
            {content}
          </div>

          {/* Gradient overlay at bottom with title */}
          <div className={`absolute bottom-0 left-0 right-0 ${gradientClass} p-3 pt-6`}>
      ...
      >
        ...
        <div className="pt-28 relative overflow-x-hidden">
          ...
          <img
            ...
            className="absolute top-0 left-0 w-full h-auto opacity-90 pointer-events-none max-w-none"
          />
          {/* <img
            src={BgShape2}
            alt="Decorative background"
            ...
            <Grid container spacing={4}>
                ...
                {renderCard(
                  ...
                  <>
                    <Box display="flex" alignItems="center" mb={2} className="font-poppins">
                      ...
                      <Typography variant="body1" sx={{ color: '#0B466D', fontWeight: 'medium' }}>
              ...
              <Grid item xs={12} md={6}>
                {renderCard(
                  "President",
                  <>
                    <Typography variant="body1" gutterBottom sx={{ color: '#0B466D', fontWeight: 'bold', fontSize: '1.1rem' }}>
