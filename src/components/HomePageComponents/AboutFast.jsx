...
const AboutFast = () => {
  return (
    <div>
        {/* 1st hero-section */}
        <div className="inline-block lg:flex lg:justify-between lg:items-center mt-2 m-4 sm:ml-20 bg-transparent">
        <div>
        <img src={Logo} alt="Image" className="mx-auto lg:flex" />
        </div>
        <div className="w-100 ml-0 lg:w-2/4 lg:ml-10 lg:mt-12">
        <h1 className="mainh1 font-extrabold text-5xl text-center lg:text-left lg:text-7xl text-[#0B466D]">ABOUT FAST</h1>
